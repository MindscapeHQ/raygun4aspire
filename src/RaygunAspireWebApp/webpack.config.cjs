  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        ...
        { from: 'scripts/third-party/prism.js', to: 'prism.js' },
        { from: 'scripts/third-party/prism-json.min.js', to: 'prism-json.min.js' },
        { from: 'scripts/third-party/prism-csharp.min.js', to: 'prism-csharp.min.js' },
      ],
    }),
  ],
};